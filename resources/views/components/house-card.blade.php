...
<div class="space-y-3 relative">
    <a href="/woningaanbod/{{ $house->id }}">
        ...
        <img src="{{ str_contains($images[0], 'qfhungarianstorage') ? $images[0] : '/storage/' . $images[0] }}" alt="" width="480px" height="350px" class="rounded min-h-[350px] max-h-[350px] object-cover object-center" />
    </a>
